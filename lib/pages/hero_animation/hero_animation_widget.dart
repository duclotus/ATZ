...
import 'hero_animation_model.dart';
export 'hero_animation_model.dart';

class HeroAnimationWidget extends StatefulWidget {
  const HeroAnimationWidget({super.key});

  static String routeName = 'HeroAnimation';
  static String routePath = '/heroAnimation';
...
class _HeroAnimationWidgetState extends State<HeroAnimationWidget> {
  late HeroAnimationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HeroAnimationModel());
  }
